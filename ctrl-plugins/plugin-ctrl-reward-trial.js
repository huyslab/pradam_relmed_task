      ...
      const generateHTML = () => {
        ...
        return `
          <main class="main-stage">
            ...
            <section class="scene">
              <img class="island-far" style="visibility: hidden;" src="imgs/Control_stims/${window.sequenceKey}/simple_island_${far}.png" alt="Farther island" />
              <div class="quest-scroll">
                ...
                <img class="island-target glowing-border" src="imgs/Control_stims/${window.sequenceKey}/simple_island_${trial.target}.png" alt="Target island">
