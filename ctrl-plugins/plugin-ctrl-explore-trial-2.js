        ...
        return `
          <main class="main-stage">
            ...
            <section class="scene">
              ...
              <img class="island-far" src="imgs/Control_stims/${window.sessionKey}/simple_island_${destinationIsland}.png" alt="Farther island" />
            ...
            <section class="scene">
              <div class="overlap-group" style="justify-content: space-between;">
                <div class="choice-left">
                  ...
                  ${islandSide === 'left' ? `<img class="island-near" src="imgs/Control_stims/${window.sessionKey}/simple_island_${destinationIsland}.png" alt="Destination island" style="top: -10%;" />` : ''}
                </div>
                <img class="island-near" style="visibility: hidden;" src="imgs/simple_island.png" alt="Hidden island" />
                <div class="choice-right">
                  ${feedbackChoice === 'right' ? 
                    `<img class="ship-${feedbackChoice}" src="imgs/simple_ship_${chosenColor}.png" alt="Ship" style="opacity: 0;" />` : ''}
                  ${islandSide === 'right' ? `<img class="island-near" src="imgs/Control_stims/${window.sessionKey}/simple_island_${destinationIsland}.png" alt="Destination island" style="top: -10%;" />` : ''}
                </div>
              </div>
            </section>
          </main>
