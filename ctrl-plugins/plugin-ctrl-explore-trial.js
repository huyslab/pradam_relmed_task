      ...
      const generateHTML = () => {
        ...
        return `
          <main class="main-stage">
            ...
            <section class="scene">
              <img class="island-far" src="imgs/Control_stims/${window.sequenceKey}/simple_island_${far}.png" alt="Farther island" />
              <!--Middle group for other islands, if needed-->
              <!--
              <div class="middle-group">
                <img class="island-middle" src="imgs/Control_stims/${window.sequenceKey}/simple_island_${left_island}.png" alt="Left island" />
                <img class="island-middle" src="imgs/Control_stims/${window.sequenceKey}/simple_island_${right_island}.png" alt="Right island" />
              </div>
              -->
              <div class="overlap-group">
                ...
                <img class="island-near" src="imgs/Control_stims/${window.sequenceKey}/simple_island_${trial.near}.png" alt="Nearer island" />
...
var jsPsychExploreShipFeedback = (function (jspsych) {
  ...
  class ExploreShipFeedbackPlugin {
    ...
    trial(display_element, trial) {
        ...
        <main class="main-stage">
          ...
          <section class="scene">
            <div class="overlap-group" style="justify-content: space-between;">
              ...
              <img class="island-near" style="visibility: hidden;" src="imgs/Control_stims/${window.sequenceKey}/simple_island_i4.png" alt="Nearer island" />
              <div class="choice-right">
              </div>
            </div>
          </section>
      ...
      islandImg.src = `imgs/Control_stims/${window.sequenceKey}/simple_island_${destinationIsland}.png`;
      // Add the image to the container
