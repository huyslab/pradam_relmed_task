...
const controlInstructionPages = [
    // Page 0: Initial Welcome
    {
        ...
        <div class="instruction-stage">
            ...
            <section class="scene">
            <img class="island-far" src="imgs/Control_stims/${window.sequenceKey}/simple_island_${downstreamIsland}.png" alt="Farther island" />
        ...
        <div class="instruction-stage">
            ...
            <section class="scene">
                <div class="overlap-group" style="justify-content: space-between;">
                    ...
                    <div class="choice-right">
                        <img class="island-near" src="imgs/Control_stims/${window.sequenceKey}/simple_island_${homebaseIsland}.png" alt="Destination island" style="top: -10%;" />
                    </div>
                </div>
            </section>
            ${createInstructionDialog(`
